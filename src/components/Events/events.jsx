...
const Events = () => {
  let redirect = false;
  let title, desc, imgname, venue, date, price;
        ...
        {data.map((item, index) => (
          <motion.div
            ...
            onClick={() => {
              ...
              desc= data[currentIndex].brief;
              imgname= data[currentIndex].imgname;
              venue= data[currentIndex].venue;
  ...
  // } else {
  //   return (
  //     <EventInfo imgname={imgname} eventDesc={desc} title={title} date={date} venue={venue} price={price}/>
  //   );
  // }
};
